...
#include "JoyShockTestLibrary/ExampleLibrary.h"
...
void FJoyShockTestModule::StartupModule()
{
	...
	FString LibraryPath;
#if PLATFORM_WINDOWS
	LibraryPath = FPaths::Combine(*BaseDir, TEXT("Binaries/ThirdParty/JoyShockTestLibrary/Win64/ExampleLibrary.dll"));
#elif PLATFORM_MAC
    LibraryPath = FPaths::Combine(*BaseDir, TEXT("Source/ThirdParty/JoyShockTestLibrary/Mac/Release/libExampleLibrary.dylib"));
